...
SERVER_IFACE="${SERVER_IFACE:-wlxfc221c300cbc}"
CLIENT1_IFACE="${CLIENT1_IFACE:-wlxfc221c300cbb}"
CLIENT2_IFACE="${CLIENT2_IFACE:-wlxfc221c500a88}"
...
常用环境变量：
  ...
  SERVER_IFACE       默认 wlxfc221c300cbc
  CLIENT1_IFACE      默认 wlxfc221c300cbb
  CLIENT2_IFACE      默认 wlxfc221c500a88
  CHANNEL            默认 157
