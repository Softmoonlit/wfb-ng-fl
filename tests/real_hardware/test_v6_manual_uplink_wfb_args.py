...
def test_server_default_radio_args() -> None:
    ...
    assert_option_value(argv, "--uplink-stream", "32")
    assert_option_value(argv, "--downlink-stream", "33")
...
def test_client1_radio_and_queue_overrides() -> None:
    ...
    assert_option_value(argv, "--role", "client")
    assert_option_value(argv, "--node-id", "1")
    assert_option_value(argv, "--uplink-stream", "40")
    assert_option_value(argv, "--downlink-stream", "41")
